...
while True:
    ...
    # print (realtime_data)
        ...
        if Y == 0:
            cv2.putText(frame,'anger',(50,70), font, 2,(255,255,255),2)
        if Y ==1:
            cv2.putText(frame,'disgust',(50,70), font, 2,(255,255,255),2)
        if Y == 2:
            cv2.putText(frame,'fear',(50,70), font, 2,(255,255,255),2)
        if Y ==3:
            cv2.putText(frame,'happiness',(50,70), font, 2,(255,255,255),2)
        if Y==4:
            cv2.putText(frame,'neutral',(50,70), font, 2,(255,255,255),2)
        if Y ==5:
            cv2.putText(frame,'sadness',(50,70), font, 2,(255,255,255),2)
        if Y==6:
            cv2.putText(frame,'surprise',(50,70), font, 2,(255,255,255),2)
